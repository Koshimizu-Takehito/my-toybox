...
@Metadata(title: .screenCollisionColorChangeTitle, description: .screenCollisionColorChangeDescription, tags: [.animation])
public struct CollisionColorChangeScreen: View {
    public init() {}
