...
public struct AutoScrolledTextFieldDemoScreen: View {
    public init() {}
...
struct AutoScrolledTextField: View {
    ...
    @State private var text = String.sample
...
private extension String {
    ...
    func isEndEdited(comparedTo other: String) -> Bool {
