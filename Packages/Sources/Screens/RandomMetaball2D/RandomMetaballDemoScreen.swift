...
@Metadata(title: .screenRandomMetaballDemoTitle, description: .screenRandomMetaballDemoDescription, tags: [.animation])
public struct RandomMetaballDemoScreen: View {
    public init() {}
