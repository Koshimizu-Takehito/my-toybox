...
///
@Metadata(title: .screenHomeIconDemoTitle, description: .screenHomeIconDemoDescription, tags: [.animation])
public struct HomeIconDemoScreen: View {
    public init() {}
    ...
    var body: some View {
        ...
        .toolbar {
            Button {
                ...
                Text(verbatim: isEditingMode ? "Done" : "Edit")
            }
